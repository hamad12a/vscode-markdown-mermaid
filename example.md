...
flowchart TD
    A("Realistic N3LO Potential $$\color{Brow}V_{N3LO}$$")
    B("Low-momentum Potential $$\color{Brow} V_{low-k}$$")
    C("Effective Potential: $$\color{Brow}V_{eff}=V_{low-k}+V_{low-k}\frac{Q}{E-H_0}V_{low-k}$$")
	...
	C --> |"Monopole/Multipole Adjustment $$\color{Gree}H = H_m +  H_M \quad$$"| D
    end
